        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
          {tracks.map((track, i) => (
            <a
              ...
              className="group relative rounded-xl overflow-hidden card-hover fade-in-up block"
              style={{
            ...
            >
              ...
              <div className="p-2.5 flex items-center justify-between">
                ...
                <svg className="w-4 h-4 text-green-400 flex-shrink-0 ml-2" fill="currentColor" viewBox="0 0 24 24">
